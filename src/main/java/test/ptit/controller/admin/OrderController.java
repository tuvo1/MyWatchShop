...
public class OrderController {
	...
	public ModelAndView cancel(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn đã bị huỷ 1 đơn hàng từ MyWatch25!",
	...
	public ModelAndView confirm(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn có 1 đơn hàng ở MyWatch25 đã được xác nhận!",
	...
	public ModelAndView delivered(ModelMap model, @PathVariable("order-id") int id) {
		...
		sendMailAction(oReal, "Bạn có 1 đơn hàng ở MyWatch25 đã thanh toán thành công!",
				"Chúng tôi cám ơn bạn vì đã ủng hộ MyWatch25", "Thông báo thanh toán thành công!");
